...
////// Emissive:
                ...
                float3 emissive = ((_StunTex_var.rgb*_StunValue_var)+((_MainTex_var.rgb*_Color_var.rgb*i.vertexColor.rgb)*node_603*(1.0 - _StunValue_var)));
